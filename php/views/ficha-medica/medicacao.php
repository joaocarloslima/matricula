...
<head>
    ...
    <title>ETECIA Matrícula - medicação controlada</title>
    <link rel="stylesheet" href="/style.css">
</head>
<body class="antialiased">
    <div class="container-center">
        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-pill">
            <path d="m10.5 20.5 10-10a4.95 4.95 0 1 0-7-7l-10 10a4.95 4.95 0 1 0 7 7Z"/>
            <path d="m8.5 8.5 7 7"/>
        </svg>
        <h1 class="text-xl text-gray-600 text-center">Medicação Controlada</h1>

        <p class="desc">Usa ou usou alguma medicação controlada?</p>

        <form action="/ficha-medica/medicacao" method="post">
...
<script>
    ...
    <?php if (!empty($matricula['medicacao'])): ?>
